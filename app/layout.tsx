...
import BuscarFichaMedicaActivaMenu from './components/BuscarFichaMedicaActivaMenu';
...
const Pantalla = () => {
  ...
  const { usuario, clave, rut, clavemaestra} = useLocalSearchParams();
  ...
  const botones = [
    ...
    { titulo: 'Buscar Ficha Médica', componente: BuscarFichaMedicaActivaMenu },
      ...
      <View style={{ flex: 1, flexDirection: 'row' }}>
        ...
        <View style={{ flex: 7, backgroundColor: '#87CEEB', padding: 20 }}>
          <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
            {React.createElement(botones[botonActivo]?.componente, { usuario, clave , rut, clavemaestra})}
          </ScrollView>
        </View>
      </View>
